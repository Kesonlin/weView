...
const isGroup = computed(() => {
  return checkboxGroup != undefined && checkboxGroup?.name === 'WvCheckboxGroup'
})
...
<template>
  <span @click.stop="handleClick" class="wv-checkbox" :size="size">
    <input type="checkbox" :name="name" :value="value" />
    <div
      class="wv-form-checkbox"
      :class="{
        'wv-form-checked': isChecked,
        'wv-checkbox-disabled wv-disabled': isDisabled,
      }"
      :wv-skin="skin"
    >
      <span class="wv-checkbox-label" v-if="slots.default || label">
        <slot>{{ label }}</slot>
      </span>
      <i
        :class="
